...
class TestGithubOrgClient(unittest.TestCase):
    ...
    def test_org(self, org, expected, get_patch):
        """ Method to test the org of the client """
    ...
    def test_public_repos(self, get_json_mock):
        """Method to test the public repos"""
...
class TestIntegrationGithubOrgClient(unittest.TestCase):
    """Method to thes test github org client"""

    @classmethod
    def setUpClass(cls):
        """Set up class to prepare for testing"""
    ...
    def tearDownClass(cls):
        """TearDown class to unprepare for testing"""
        cls.get_patcher.stop()

    def test_public_repos(self):
        """Metho to test public repos"""
        y = GithubOrgClient("x")
    ...
    def test_public_repos_with_license(self):
        """Method to test public repos with licence"""
        y = GithubOrgClient("x")
        self.assertEqual(y.org, self.org_payload)
        self.assertEqual(y.repos_payload, self.repos_payload)
        self.assertEqual(y.public_repos(), self.expected_repos)
